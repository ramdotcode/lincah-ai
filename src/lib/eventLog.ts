...
export interface EventLogPayload {
  ...
  channel: 'telegram' | 'whatsapp' | 'webchat' | 'playground';
  event_type: 'message_processed' | 'ai_error' | 'webhook_error' | 'handoff' | 'rate_limited' | 'stage_classified' | 'labels_classified' | 'followup_sent' | 'followup_failed' | 'agent_handoff' | 'payment_paid';
